...
JsonExportConfig = CopyOnAccessDict(
    {
        ...
        "iTorx Export (continue)": TestCycleJsonReportOptions(
            treeRootUID=None,
            basedOnExecution=False,
            suppressFilteredData=True,
            suppressNotExecutable=True,
            suppressEmptyTestThemes=True,
            executionMode=ExecutionMode.CONTINUE,
            filters=[],
        ),
        "iTorx Export (view)": TestCycleJsonReportOptions(
            treeRootUID=None,
            basedOnExecution=False,
            suppressFilteredData=True,
            suppressNotExecutable=True,
