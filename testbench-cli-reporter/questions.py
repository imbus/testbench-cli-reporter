...
def selection_prompt(message: str, choices: list[Choice], no_valid_option_message: str = None, style: dict = custom_style_fancy):
...
def checkbox_prompt(message: str, choices: list[Choice], no_valid_option_message: str = None, style: dict = custom_style_fancy):
    valid_choices = [choice for choice in choices if not choice.disabled]
    if valid_choices:
        return checkbox(
            message=message,
...
def text_prompt(message, type = 'text', validation = lambda val: val != "", style = custom_style_fancy):
    question = [
        {
            'type': type,
            'name': 'sole_question',
